...
for (document, summary) in zip(documents, summaries):
    ...
    results = calculate_metrics(s1, summary_tokens)
    ...
    results = calculate_metrics(s4, summary_tokens)
